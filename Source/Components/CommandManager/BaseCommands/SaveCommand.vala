        ...
        */        
        public async void Run () {
            ...
            if (contentMessage.Content is FileContent) {
                var content = contentMessage.Content as FileContent;
                var fsm = (FileSavedMessage) yield MessageDispatcher.GetInstance ().Send (this.get_type (), typeof (FileOperations), new SaveFileMessage (content));
